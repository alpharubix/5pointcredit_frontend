        ...
        <div className="p-0">
          <table className="w-full text-sm text-left whitespace-nowrap">
            <thead className="bg-[#000080] text-white">
              <tr>
                <th className="px-4 py-2 border border-[#000080] font-semibold text-center w-1/3">Month</th>
                <th className="px-4 py-2 border border-[#000080] font-semibold text-center w-1/3">Taxable Value</th>
                <th className="px-4 py-2 border border-[#000080] font-semibold text-center w-1/3">Tax</th>
              </tr>
            </thead>
            <tbody>
